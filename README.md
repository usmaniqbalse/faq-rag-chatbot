...
1. In the sidebar, upload a **PDF** and click **⚡️ Process** (embeds & stores chunks).
2. In the main area, type your question and click **🔥 Ask**.
3. Read the streamed answer. Expand the panels to see retrieved docs and the selected most-relevant chunks.
